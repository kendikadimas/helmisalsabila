  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="pb-2 border-b border-[#21262d]">
        <h1 className="text-xl font-semibold text-slate-100 tracking-tight">Site Settings</h1>
        <p className="text-xs text-slate-400 mt-1">Konfigurasi hero section, kontak WhatsApp, dan URL Saweria.</p>
      </div>

      <div className="p-5 sm:p-6 rounded-xl bg-[#0d1117] border border-[#21262d]">
        <form action={handleUpdate} className="space-y-5 text-xs">
          <div className="space-y-1">
            <label className="font-medium text-slate-400">Headline Hero Section</label>
            <input
              type="text"
              name="heroTitle"
          ...
          <div className="space-y-1">
            <label className="font-medium text-slate-400">Subtitle Hero Section</label>
            <input
              type="text"
              name="heroSubtitle"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1">
              <label className="font-medium text-slate-400">Nomor WhatsApp Resmi</label>
              <input
                type="text"
                name="contactPhone"
            ...
            <div className="space-y-1">
              <label className="font-medium text-slate-400">Lokasi / Alamat</label>
              <input
                type="text"
                name="contactAddress"
          ...
          <div className="space-y-1">
            <label className="font-medium text-slate-400">URL Saweria (Donasi Artikel)</label>
            <input
              type="url"
              name="saweriaUrl"
          ...
          <div className="pt-3 border-t border-[#21262d] flex justify-end">
            <button
              type="submit"
              className="px-4 py-2 rounded-lg bg-teal-600 hover:bg-teal-500 text-white font-medium text-xs flex items-center gap-1.5 transition-colors cursor-pointer"
            >
