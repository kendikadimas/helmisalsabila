    ...
    <div className="space-y-10 w-full max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200">
        ...
        <Link
          href="/"
          target="_blank"
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white hover:bg-slate-50 border border-slate-200 text-sm font-medium text-slate-700 hover:text-slate-900 transition-colors self-start sm:self-auto shadow-xs"
        >
        ...
        {stats.map((stat) => {
          ...
          return (
            <Link
              key={stat.title}
              href={stat.href}
              className="p-6 rounded-2xl bg-white border border-slate-200 hover:border-slate-300 transition-all hover:shadow-sm group space-y-4 shadow-xs"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link
              href="/admin/services"
              className="p-6 rounded-2xl bg-white border border-slate-200 hover:border-slate-300 transition-all hover:shadow-sm group flex items-start justify-between space-x-4 shadow-xs"
            >
              <div className="space-y-1.5">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-base font-semibold text-slate-900 group-hover:text-amber-700 transition-colors">
                    Layanan & Portfolio
                  </span>
                </div>
            ...
            >
              <div className="space-y-1.5">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-base font-semibold text-slate-900 group-hover:text-rose-700 transition-colors">
                    Produk Digital
                  </span>
                </div>
                <p className="text-xs text-slate-500 leading-relaxed">
            ...
            >
              <div className="space-y-1.5">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-base font-semibold text-slate-900 group-hover:text-sky-700 transition-colors">
                    Artikel & Blog
                  </span>
                </div>
                <p className="text-xs text-slate-500 leading-relaxed">
        ...
        <div className="space-y-4">
          ...
          <div className="p-6 rounded-2xl bg-white border border-slate-200 divide-y divide-slate-100 space-y-4 shadow-xs">
            {articles.slice(0, 4).map((art) => (
              <div key={art.id} className="pt-4 first:pt-0 space-y-1.5">
                <div className="flex items-center justify-between text-xs text-slate-500">
                  <span className="text-teal-700 font-medium">{art.category || "Umum"}</span>
                  <span className="font-mono text-xs">{art.viewsCount || 0} views</span>
                </div>
                <h3 className="text-sm font-semibold text-slate-800 hover:text-teal-700 transition-colors line-clamp-2 leading-snug">
